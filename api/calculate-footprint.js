...
const waterSavings = {
  dresses: 1813,
  jacketsExcludingDenim: 1427,
  denimJeansAndJackets: 5455,
  trousersExcludingDenim: 4073,
  tshirtsAndTops: 2333,
};
...
// CORS configuration to allow requests from frontend URL (replace with actual frontend URL)
const corsOptions = {
  origin: 'https://dissertation-amber.vercel.app', // Replace with your frontend URL
};
